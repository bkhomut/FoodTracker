...
//  FoodTracker
//
//  Created by Boris Khomut on 12/20/14.
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchControllerDelegate,UISearchResultsUpdating {
    ...
    let kAppId = "401d96e4"
    let kAppKey = "52c77e6743cbf8e04cd8e384e680ffc1"
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if selectedScopeButtonIndex == 0 {
            ...
            self.dataController.savedUSDAItemForId(idValue, json: self.jsonResponse)
...
// How to make an HTTP POST Request
        ...
        var task = session.dataTaskWithRequest(request, completionHandler: { (data, reponse, err) -> Void in
