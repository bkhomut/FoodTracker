//
//  DataConrtroller.swift
//  FoodTracker
//
//  Created by Boris Khomut on 12/22/14.
...
class DataController {
    ...
    func savedUSDAItemForId(idValue : String, json : NSDictionary) {
        if json["hits"] != nil {
            let results:[AnyObject] = json["hits"]! as [AnyObject]
                            ...
                            if fieldsDictionary["usda_fields"] != nil {
                                ...
                                if usdaFieldsDictionary["CHOLE"] != nil {
                                    ...
                                    if cholesterolDictionary["value"] != nil {
                                        ...
                                        usdaItem.chlosterol = "\(cholesterolValue)"
                                    }
                                } else {
                                    usdaItem.chlosterol = "0"
                                }
